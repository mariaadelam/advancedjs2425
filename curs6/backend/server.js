...
const { renderPage } = require('./layout'); //layout.js - import
const querystring = require('querystring');

// Creăm un server HTTP
// Folosim modulul http pentru a crea un server
const server = http.createServer((req, res) => {
    if (req.url === '/' || req.url === '/acasa') {
        ...
        req.on('end', () => {
            ...
            const html = renderPage('despre.html', mesaj); //parsez rezultatul pe pagina despre.html
